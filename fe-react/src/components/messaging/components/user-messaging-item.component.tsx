...
const UserMessagingItem: FC<UserMessagingItemProperties> = ({
  profileImage, name, date, lastMessagePreview, status
}) => (
  <div className="hu-message-item tw-flex tw-items-center tw-gap-2 tw-relative tw-p-2">
    ...
    <PresenceIndicator status={status} className="tw-absolute tw-bottom-3 tw-left-11" />
    <div className="hu-message-item--info tw-relative">
      ...
      <div className="tw-flex">
        <span className="hu-message-item--preview tw-text-xs tw-overflow-hidden tw-text-ellipsis tw-text-gray-600">{lastMessagePreview}</span>
